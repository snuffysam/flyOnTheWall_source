...
public class Midpoint2_Cut_3 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        textToSend1[textToSend1.Length-1] = new TextboxScript.TextBlock{speakerName = "", text = MissionManager.GetCharmTutorial(), emphasis = false};
    }
